...
const oldCalc = extractLiteral('index_13dbc13.html', 'function calculateModel(', 'function getGrade(');
const oldApp = extractLiteral('index_13dbc13.html', 'function renderApp(', 'async function runBacktest()');
const oldBook = extractLiteral('index_13dbc13.html', 'function changeBook(', 'function formatDateStr(');
